                  ...
                  tabsetPanel(type = "pills",
                              ...
                              tabPanel("Kinetics",
                                       ...
                                       sidebarPanel(
                                         class = "scrollable",
                                         h3("Select parameters for the plot."),
                                         checkboxInput(inputId = "kin_theory",
                                                       label = "Theoretical calculations",
                                                       value = FALSE),
                                         radioButtons(inputId = "kin_calc_type",
                                                      label = "Choose values type:",
                                                      choices = c("relative", "absolute"),
                                                      selected = "relative"),
                                         h5("Choose time parameters:"),
                                         splitLayout(
                                           selectInput(inputId = "kin_in_time",
                                                       label = "IN",
                                                       choices = c("0", "1", "5", "25", "1440")),
                                           selectInput(inputId = "kin_out_time",
                                                       label = "OUT",
                                                       choices = c("0", "1", "5", "25", "1440"))),
                                         h5("Choose peptide:"),
                                       ...
                                       mainPanel(
                                         tabsetPanel(
                                           tabPanel(
                                             "Kinetic plot",
                                             br(),
                                             withSpinner(plotOutput("kinetic_plot_chosen_peptides", height = 600)),
